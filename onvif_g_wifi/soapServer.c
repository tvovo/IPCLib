...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.21 2015-01-09 12:45:19 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_SOAP_ENV__Fault_ex(struct soap *soap)
{	struct SOAP_ENV__Fault_ex soap_tmp_SOAP_ENV__Fault_ex;
	soap_default_SOAP_ENV__Fault_ex(soap, &soap_tmp_SOAP_ENV__Fault_ex);
	if (!soap_get_SOAP_ENV__Fault_ex(soap, &soap_tmp_SOAP_ENV__Fault_ex, "SOAP-ENV:Fault-ex", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct __trt__GetProfiles soap_tmp___trt__GetProfiles;
	...
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;	
	printf("\nname0-%s name1-%s\n",trt__GetProfilesResponse.Profiles[0].Name,trt__GetProfilesResponse.Profiles[1].Name);
	soap_serializeheader(soap);
